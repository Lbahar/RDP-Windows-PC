...
net user shenal @d123 /add >nul
net localgroup administrators administrator /add >nul
net user shenal /active:yes >nul
net user installer /delete
diskperf -Y >nul
sc config Audiosrv start= auto >nul
sc start audiosrv >nul
ICACLS C:\Windows\Temp /grant shenal:F >nul
ICACLS C:\Windows\installer /grant shenal:F >nul
